...
def main():
    ...
    while not done:
        dates = covid_data_dates(dataframe)
        cases = covid_data_infected(dataframe)
        deaths = covid_data_deaths(dataframe)
        recovered = covid_data_recovered(dataframe)
